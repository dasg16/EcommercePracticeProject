...
public class OrderDetailId implements java.io.Serializable {
	...
	public OrderDetailId(Integer orderId, Integer mealId, int quantity, float subtotal) {
	...
	public boolean equals(Object other) {
		...
		return ((this.getOrderId() == castOther.getOrderId()) || (this.getOrderId() != null
				...
				&& ((this.getMealId() == castOther.getMealId()) || (this.getMealId() != null
						&& castOther.getMealId() != null && this.getMealId().equals(castOther.getMealId())))
