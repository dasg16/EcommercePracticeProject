...
public class Customer implements java.io.Serializable {
	...
	private Set mealOrders = new HashSet(0);
	...
	public Customer(String email, String fullname, String address, String city, String country, String phone,
			String zipcode, String password, Date registerDate, Set reviews, Set mealOrders) {
		this.email = email;
		this.fullname = fullname;
		this.address = address;
		this.city = city;
	...
	public Set getMealOrders() {
		return this.mealOrders;
	}

	public void setMealOrders(Set mealOrders) {
		this.mealOrders = mealOrders;
	}
